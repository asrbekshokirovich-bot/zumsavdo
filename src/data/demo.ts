...
/**
 * DEMO toʻplami — dizaynni koʻrish uchun.
 *
 * Bu yerdagi raqamlarning hech biri haqiqiy emas: sotuvchi nomlari, mahsulot
 * nomlari, narxlar va buyurtmalar — hammasi shu fayldagi generator toʻqigan.
 *
 * Toʻplam faqat foydalanuvchi ochiq soʻraganda ishga tushadi (`?demo=1`) va
 * yoqilganda panelning har sahifasida oʻchmaydigan DEMO belgisi turadi.
 * Sababi oddiy: ilgari bu toʻplam ombor boʻsh boʻlganda oʻzi ishga tushardi
 * va toʻqilgan raqamlar haqiqiy oʻlchov deb oʻqilib qolgan edi.
 */
...
/** Demo toʻplamini yaratadi. Har safar bir xil — seed oʻzgarmaydi. */
